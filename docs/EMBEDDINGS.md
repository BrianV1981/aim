...
A.I.M. uses a centralized SQLite database (`archive/engram.db`) to store all session fragments and their corresponding embeddings.
...
1.  **Old Index is Void**: The `engram.db` is now mathematically useless.
