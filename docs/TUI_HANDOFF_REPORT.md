...
We are currently in a heavy refinement phase for the **Sovereign Cockpit (`aim tui`)**. The TUI is the central nervous system for configuring the A.I.M. Exoskeleton, mapping directly to `core/CONFIG.json` and the OS `keyring`. 
