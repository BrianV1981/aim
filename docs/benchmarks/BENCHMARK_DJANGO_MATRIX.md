...
2.  **Context Efficiency:** Using localized Hybrid RAG (`aim search`) against pre-compiled `.engram` cartridges reduced context consumption by 50% compared to brute-force repository scanning.
