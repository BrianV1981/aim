...
1. **Telemetry Anonymization:** Implement a scrubber for `~/.gemini/telemetry.log` before any future aggregation (Phase 9).
2. **Global Alias Expansion:** Promote the `aim` alias to support project-specific sub-commands.
