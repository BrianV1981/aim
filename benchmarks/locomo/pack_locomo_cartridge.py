#!/usr/bin/env python3
"""
A.I.M. LoCoMo Cartridge Packager
Converts the finished locomo.db into a portable .engram cartridge.
"""
...
OUTPUT_FILE = DATA_DIR / "locomo.engram"
...
def main():
    ...
    print(f"Database has {session_count} sessions embedded.")
    ...
    with tempfile.TemporaryDirectory(prefix="aim_foundry_") as tmpdir:
        ...
        for i, (sess_id, filename, mtime) in enumerate(sessions):
            ...
            with open(jsonl_path, 'w') as f:
                ...
                for frag_id, content, emb, meta, parent_id in fragments:
                    ...
                    if hasattr(db, '_blob_to_vec') and emb:
        ...
        metadata = {
            ...
            "manifest": {
                ...
                "version": "1.0.0",
                "description": "LoCoMo Benchmark Pre-Embedded Haystack",
