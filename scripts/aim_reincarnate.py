...
def main():
    ...
    wake_up_prompt = "Wake up. 1. Read GEMINI.md and acknowledge your core constraints. 2. Read handoff.md. 3. MANDATE: You must read continuity/LAST_SESSION_CLEAN.md, continuity/CURRENT_PULSE.md, and ISSUE_TRACKER.md before taking any action or responding."
    try:
        subprocess.run(
