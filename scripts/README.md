...
*   **`aim_crash.py`**: The Crash Recovery Engine. Salvages interrupted or crashed sessions, extracts their signal, generates an autonomic handoff pulse, and stabilizes the environment.
