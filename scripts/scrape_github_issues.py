...
def main():
    ...
    parser.add_argument("--repo", default=None, help="Target repository (e.g., google/gemini-cli). Defaults to local repo.")
    ...
    # Resolve aim_root dynamically so it works in worktrees
